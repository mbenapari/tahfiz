    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-text-muted">Manage staff and lesson assignments.</p>
        </div>
        {!showCreateForm && (
          <button 
            onClick={() => {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  placeholder="John"
                  className="bg-white/5 border border-border-green/20 rounded-xl px-4 py-2.5 text-white placeholder:text-text-muted/50 focus:outline-none focus:border-primary/50 transition-colors"
                  required
                />
              </div>
            ...
            <div className="flex gap-3 pt-4">
              <button
                ...
                className="flex items-center gap-2 bg-primary hover:bg-primary-hover text-background-dark px-6 py-2.5 rounded-xl font-bold transition-all disabled:opacity-50"
              >
              ...
              <button
                type="button"
                onClick={resetForm}
                className="px-6 py-2.5 rounded-xl font-bold text-text-muted hover:text-white hover:bg-white/5 transition-colors"
              >
                Cancel
              </button>
            </div>
      ...
      <div className="bg-surface-dark border border-border-green/30 rounded-2xl overflow-hidden min-h-[400px] flex flex-col">
        {isLoading ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-4 text-text-muted">
            ...
            <p className="font-medium">Loading instructors...</p>
          </div>
        ) : error ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-4 text-text-muted p-8 text-center">
            ...
            <div>
              <p className="font-bold text-lg text-white">No instructors yet</p>
              <p className="text-sm mt-1">Get started by adding your first instructor.</p>
            </div>
          </div>
        ) : (
